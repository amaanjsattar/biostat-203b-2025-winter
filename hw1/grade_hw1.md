...
- Q3 (18/20)
  ...
  - Q3.4. No output displayed for the second part of the question. `-1.0`

  - Q3.6. `-c` is missing so that the frequencies are not displayed.`-1.0`
