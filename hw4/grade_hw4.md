...
-   Is the report clear (whole sentences, typos, grammar)? Do readers have a clear idea what's going on and how results are produced by just reading the report? Take some points off if the solutions are too succinct to grasp, or there are too many typos/grammar. 
    ...
    - Your html file is the default version (pdf looks good). `-2.0`

### Completeness, correctness and efficiency of solution: 198/200
...
Q1.8 summaries should roughly match those given.
  ...
  - Q1.8. "Other" in `race` should be placed at the end. `-0.0` 

- Q2 (98/100)

  To avoid unnecessary computation time, I believe that unspecified variables—especially time variables—should not be displayed. `-0.0`

  2nd tab: ICU stay information looks incomplete because only one panel (not multiple vitals) is shown. `-2.0`
